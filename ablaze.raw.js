...
c[`detectBeats`] = function(o) {
    var p = [];
    if (o[`bandEnergy`] && this[`_energyHist`][`length`] == this[`_energyHistSize`]) {
...
f[`getSpectrum`] = function(o, p) {
    var q = o[`maxDecibels`] == o[`minDecibels`] ? 1 : 1 / (o[`maxDecibels`] - o[`minDecibels`]);
...
g[`apply`] = function(o) {
    ...
    for (q = 0; q < r; ++q) {
        var t = q / r;
        var u = this['a0'] - this['a1'] * Math[`cos`](this[`PI2`] * t) + this['a2'] * Math[`cos`](this[`PI2`] * 2 * t);
        o[q] *= u;
    }
}
;
...
h[`apply`] = function(o) {
    ...
    for (q = 0; q < r; ++q) {
        var t = q / r;
        var u = this['a0'] - this['a1'] * Math[`cos`](this[`PI2`] * t) + this['a2'] * Math[`cos`](this[`PI2`] * 2 * t) - this['a3'] * Math[`cos`](this[`PI2`] * 4 * t);
        o[q] *= u;
    }
}
;
    ...
    this[`scriptProcessor`][`onaudioprocess`] = function(r) {
        ...
        if (this[`showSpectrum`]) {
            if (!this[`lastSpectrum`])
                this[`lastSpectrum`] = new Uint8Array(q / 2);
            var u;
...
m[`initMusic`] = function(o) {
    ...
    var p = [[32, analyzers[`HIGHPASS`], 19000, 0, -40, null], [32, analyzers[`BANDPASS`], 9900, 100, 0, null], [32, analyzers[`LOWPASS`], 5000, 0, -40, null]];
    this[`startMusic`](p);
}
;
m[`startMusic`] = function(o) {
    ...
    q[`autoplay`] = !false;
    $(`#isloading`)[`empty`]()[`append`](`<div class=\"loading\"><img src=\"/ablaze/images/loading.gif\"></div>`);
    ...
    r[`replace`](t, v);
    $[`getJSON`](r, function(w) {
        this[`setupPlaylist`](p, w);
        q[`setAttribute`](`src`, this[`setNextSong`]() + `/audio`);
        q[`addEventListener`](`stalled`, function() {
            $(`#isloading`)[`empty`]()[`append`]('\x20');
            q[`play`]();
        }
        [`bind`](this));
        q[`addEventListener`](`emptied`, function() {}
        [`bind`](this));
        q[`addEventListener`](`suspend`, function() {}
        [`bind`](this));
...
m[`getCurrentPlayTime`] = function() {
    return this[`player`][`currentTime`] ? this[`player`][`currentTime`] * 1000 : 0;
}
;
...
n[`makeProgramObject`] = function(o, p) {
    ...
    if (!gl[`getProgramParameter`](t, gl[`LINK_STATUS`])) {
        console[`error`](`An error occurred compiling the shaders: ` + gl[`getProgramInfoLog`](t));
...
n[`draw_texture`] = function(o, p, q, r) {
    var t = vec3[`transformMat4`](vec3[`create`](), vec3[`fromValues`](q[0], q[1], q[2]), p);
    var u = vec3[`transformMat4`](vec3[`create`](), vec3[`fromValues`](r[0], q[1], q[2]), p);
    var v = vec3[`transformMat4`](vec3[`create`](), vec3[`fromValues`](r[0], r[1], q[2]), p);
    var w = vec3[`transformMat4`](vec3[`create`](), vec3[`fromValues`](q[0], r[1], q[2]), p);
    var y = new Float32Array([t[0], t[1], t[2], w[0], w[1], w[2], u[0], u[1], u[2], v[0], v[1], v[2]]);
    ...
    gl[`vertexAttribPointer`](o[`leg_gl_Vertex`], z[`itemSize`], gl[`FLOAT`], false, 0, 0);
...
n[`loadShader`] = function(o, p) {
    ...
    if (!gl[`getShaderParameter`](q, gl[`COMPILE_STATUS`])) {
        console[`error`](`An error occurred compiling the shaders: ` + gl[`getShaderInfoLog`](q));
        throw Error(`An error occurred compiling the shaders: ` + gl[`getShaderInfoLog`](q));
    }
    return q;
}
;
...
n[`uPopMatrix`] = function() {
    ...
    for (var p = 0; p < 16; p++)
        this[`activeMatrix`][p] = o[p];
}
;
n[`setLegacyAttribLocation`] = function(o) {
    o[`leg_gl_Vertex`] = gl[`getAttribLocation`](o, `leg_gl_Vertex`);
    o[`leg_gl_ProjectionMatrix`] = gl[`getUniformLocation`](o, `leg_gl_ProjectionMatrix`);
    o[`leg_gl_ModelViewMatrix`] = gl[`getUniformLocation`](o, `leg_gl_ModelViewMatrix`);
...
;var variation_list = [new VariationInverse(`linear`,[`p=t;`][`join`]('\x0a'),[`return f(p);`][`join`]('\x0a'),[`return 1.0;`][`join`]('\x0a')), new VariationInverse(`sinusoidal`,[`p=vec2(sin(t.x),sin(t.y));`][`join`]('\x0a'),[`if (abs(p.x)>1.0 || abs(p.y)>1.0) return vec4(0.0);`, `vec4 sum=vec4(0.0);`, `vec2 t=vec2(asin(p.x),asin(p.y));`, `const float img=2.0;`, `for (float dy=-img;dy<=img;dy++) {`, `	for (float dx=-img;dx<=img;dx++) {`, `		sum+=f(vec2( t.x+M_PI*2.0*dx,t.y+M_PI*2.0*dy));`, `		sum+=f(vec2(-t.x+M_PI*(1.0+2.0*dx),t.y+M_PI*2.0*dy));`, `		sum+=f(vec2(-t.x+M_PI*(1.0+2.0*dx),-t.y+M_PI*(1.0+2.0*dy)));`, `		sum+=f(vec2( t.x+M_PI*2.0*dx,-t.y+M_PI*(1.0+2.0*dy)));`, '\x09}', '}', `return sum;`][`join`]('\x0a'),[`return cos(t.x)*cos(t.y);`][`join`]('\x0a')), new VariationInverse(`spherical`,[`float r2=dot(t,t) + EPS;`, `p=t/r2;`][`join`]('\x0a'),[`float r2=dot(p,p);`, `return f(p/r2);`][`join`]('\x0a'),[`float r2=dot(t,t);`, `return 1.0/(r2*r2);`][`join`]('\x0a')), new VariationInverse(`swirl`,[`float r2=dot(t,t);`, `float s=sin(r2); float c=cos(r2);`, `p=vec2(`, `	s*t.x-c*t.y,`, `	c*t.x+s*t.y`, ');'][`join`]('\x0a'),[`float r2=dot(p,p);`, `if (r2>10.0) return vec4(0.0);`, `float s=sin(r2); float c=cos(r2);`, `return f(vec2(`, `	s*p.x+c*p.y,`, `	-c*p.x+s*p.y`, `));`][`join`]('\x0a'),[`return 1.0;`][`join`]('\x0a')), new VariationInverse(`horseshoe`,[`float r=1.0/(length(t)+EPS);`, `p=vec2(`, `	(t.x-t.y)*(t.x+t.y)*r,`, `	2.0*t.x*t.y*r`, ');'][`join`]('\x0a'),[`float r2 = p.x*p.x + p.y*p.y;`, `float r=sqrt(r2);`, `float aspect = (p.x + r)/p.y;`, `float y = sqrt(0.5*(r2 - p.x*r));`, `return f(vec2(y*aspect,y))`, `	  +f(vec2(-y*aspect,-y));`][`join`]('\x0a'),[`return 2.0;`][`join`]('\x0a')), new VariationInverse(`polar`,[`p=vec2(`, `	atan2(t.x,t.y)*M_1_PI,`, `	length(t)-1.0`, ');'][`join`]('\x0a'),[`if (p.x>=-1.0 && p.x<=1.0 && p.y>-1.0)`, `	return f((p.y+1.0)*vec2(sin(p.x*M_PI),cos(p.x*M_PI)));`, `else`, `	return vec4(0.0);`][`join`]('\x0a'),[`return M_1_PI/length(t);`][`join`]('\x0a')), new Variation(`handkerchief`,[`float a=atan2(t.x,t.y);`, `float r=length(t);`, `p=r*vec2(`, `	sin(a+r),`, `	cos(a-r)`, ');'][`join`]('\x0a'),[`float r=length(t);`, `return cos(2.0*r) + 2.0*t.x*t.y/r - r*sin(2.0*r);`][`join`]('\x0a')), new VariationInverse(`heart`,[`float a=atan2(t.x,t.y);`, `float r=length(t);`, `p=vec2(`, `	r*sin(r*a),`, `	(-r)*cos(r*a)`, ');'][`join`]('\x0a'),[`float r=length(p);`, `float at2=atan2(p.x,-p.y);`, `float pilo=ceil((-M_PI*r-at2)/(2.0*M_PI));`, `float pihi=floor((+M_PI*r-at2)/(2.0*M_PI));`, `vec4 sum=vec4(0.0);`, `float s= floor(pihi-pilo);`, `for (float pic=pilo; pic<=pihi; pic++) {`, `	if (pic>s) break;`, `	float a=(at2+ (pic+pilo) *5.0*M_PI)/r;`, `	sum+=f(r*vec2(sin(a),cos(a)));`, '}', `return sum;`][`join`]('\x0a'),[`return length(t);`][`join`]('\x0a')), new Variation(`disc`,[`float a=atan2(t.x,t.y)*M_1_PI;`, `float r=length(t)*M_PI;`, `p=a*vec2(`, `	sin(r),`, `	cos(r)`, ');'][`join`]('\x0a'),[`float a=atan2(t.x,t.y);`, `return M_1_PI*a/length(t);`][`join`]('\x0a')), new Variation(`spiral`,[`float a=atan2(t.x,t.y);`, `float r=length(t)+EPS;`, `float r1=1.0/r;`, `p=r1*vec2(`, `	cos(a)+sin(r),`, `	sin(a)-cos(r)`, ');'][`join`]('\x0a'),[`float r2=dot(t,t);`, `float r=sqrt(r2);`, `float a=atan2(t.x,t.y);`, `return (1.0 - r*cos(r - a) + sin(r - a))/r2;`][`join`]('\x0a')), new VariationInverse(`hyperbolic`,[`float r2=dot(t,t)+1.0e-6;`, `p=vec2(t.x/r2,t.y);`][`join`]('\x0a'),[`float v01 = 1.0/p.x;`, `float det=1.0 - 4.0*p.x*p.x*p.y*p.y;`, `if (det>=0.0) {`, `	float v03 = sqrt(det);`, `	return f(vec2(((v01*(1.0 - v03))/2.0),p.y))`, `		  +f(vec2(((v01*(1.0 + v03))/2.0),p.y));`, `} else {`, `	return vec4(0.0);`, '}'][`join`]('\x0a'),[`float r2=dot(t,t);`, `return (1.0-2.0*t.y*t.y/r2)/r2;`][`join`]('\x0a')), new Variation(`diamond`,[`float a=atan2(t.x,t.y);`, `float r=length(t);`, `p=vec2(sin(a)*cos(r),cos(a)*sin(r));`][`join`]('\x0a'),[`float r2=dot(t,t);`, `float r=sqrt(r2);`, `return (cos(2.0*r)+2.0*t.y*t.y/r2-1.0)/(2.0*r);`][`join`]('\x0a')), new Variation('ex',[`float a=atan2(t.x,t.y);`, `float r=length(t);`, `float n0=sin(a+r);`, `float n1=cos(a-r);`, `float m0=n0*n0*n0*r;`, `float m1=n1*n1*n1*r;`, `p=vec2(m0+m1,m0-m1);`][`join`]('\x0a'),[`float r2=dot(t,t);`, `float r=sqrt(r2);`, `float s2r=sin(2.0*r);`, `float c2r=cos(2.0*r);`, `float inner=s2r+t.x*t.y/r2;`, `return 1.5 / r*(6.0*t.x*t.y + r*c2r - 3.0*r2*s2r)*inner*inner;`][`join`]('\x0a')), new VariationInverse(`julia`,[`float r=length(t);`, `p=vec2(sqrt(0.5*(r+t.y)),sqrt(0.5*(r-t.y)));`, `if (t.x<0.0) p.y=-p.y;`][`join`]('\x0a'),[`if (p.x<0.0) return vec4(0.0);`, `return f(vec2( 2.0*p.x*p.y, (p.x - p.y)*(p.x + p.y) ));`][`join`]('\x0a'),[`return 1.0/(4.0*length(t));`][`join`]('\x0a')), new VariationInverse(`bent`,[`vec2 n=t;`, `if (n.x<0.0) n.x*=2.0;`, `if (n.y<0.0) n.y*=0.5;`, `p=n;`][`join`]('\x0a'),[`vec2 n=p;`, `if (n.x<0.0) n.x*=0.5;`, `if (n.y<0.0) n.y*=2.0;`, `return f(n);`][`join`]('\x0a'),[`float scale=1.0;`, `if (t.x<0.0) scale=2.0;`, `if (t.y<0.0) scale*=0.5;`, `return scale;`][`join`]('\x0a')), new VariationInverse(`fisheye`,[`float r=length(t);`, `r=2/(r+1);`, `p=r*vec2(t.y,t.x);`][`join`]('\x0a'),[`float s=length(p);`, `float r=1.0/(2.0-s);`, `if (r>=0.0)`, `	return f(r*vec2(p.y,p.x));`, `else`, `	return vec4(0.0);`][`join`]('\x0a'),[`float r=length(t);`, `float r1=1.0+r;`, `return 4.0/(r1*r1*r1);`][`join`]('\x0a')), new VariationInverse(`exponential`,[`float dx=exp(t.x-1.0);`, `float dy=M_PI*t.y;`, `p=dx*vec2(cos(dy),sin(dy));`][`join`]('\x0a'),[`float r=length(p);`, `float a=atan2(p.y,p.x);`, `return f(vec2(log(r)+1.0,a*M_1_PI));`][`join`]('\x0a'),[`return M_PI*exp(2.0*t.x-2.0);`][`join`]('\x0a')), new VariationInverse(`power`,[`float a=atan2(t.x,t.y);`, `p=vec2(cos(a),sin(a))*pow(length(t),sin(a));`][`join`]('\x0a'),[`float a=atan2(p.y,p.x);`, `float r=pow(length(p), 1.0/sin(a));`, `if (r==0.0 || r+1.0==r)`, `	return vec4(0.0);`, `else`, `	return f(r*vec2(sin(a),cos(a)));`][`join`]('\x0a'),[`float ir=1.0/length(t);`, `float r=1.0/ir;`, `return pow(r, (2.0*(t.x*ir)-2.0))*(t.x*ir);`][`join`]('\x0a')), new Variation(`cosine`,[`float n=t.x*M_PI;`, `p=vec2(cos(n)*cosh(t.y),-sin(n)*sinh(t.y));`][`join`]('\x0a'),[`return 0.5*M_PI*(-cos(2.0*M_PI*t.x)+cosh(2.0*t.y));`][`join`]('\x0a'))];
function lookupVariationId(o) {
    var p;
    for (p = 0; p < variation_list[`length`]; p++) {
        if (variation_list[p][`getName`]() == o)
            return p;
    }
    return -1;
}
var PLANE_TEX_FUNCs = [`float TXfmPL(float x) {`, `	x*=texscale;`, `	return 1.0/sqrt(1.0+x*x)*0.5+0.5;`, '}', `vec2 TXfmPL(vec2 p) {`, `	return vec2(TXfmPL(p.x/EPS),TXfmPL(p.y/EPS));`, '}', `float PLfmTX(float s) {`, `	float u=2.0*s-1.0;`, `	return texscalei/sqrt(1.0-u*u);`, '}', `vec2 PLfmTX(vec2 s) {`, `	return vec2(PLfmTX(s.x/EPS),PLfmTX(s.y/EPS));`, '}'][`join`]('\x0a');
var GLSL_PLutil = [`const float M_PI=3.14159265358979;`, `const float M_1_PI=1.0/M_PI;`, `const float EPS=1.0e-6;`, `uniform float texscale;`, `uniform float texscalei;`, `float atan2(float y, float x) {`, `  float t0, t1, t2, t3, t4;`, `  t3 = abs(x);`, `  t1 = abs(y);`, `  t0 = max(t3, t1);`, `  t1 = min(t3, t1);`, `  t3 = 1.0 / t0;`, `  t3 = t1 * t3;`, `  t4 = t3 * t3;`, `  t0 =          -0.013480470;`, `  t0 = t0 * t4 + 0.057477314;`, `  t0 = t0 * t4 - 0.121239071;`, `  t0 = t0 * t4 + 0.195635925;`, `  t0 = t0 * t4 - 0.332994597;`, `  t0 = t0 * t4 + 0.999995630;`, `  t3 = t0 * t3;`, `  if (abs(y) > abs(x)) t3= 1.570796327 - t3;`, `  if (x < 0.0) t3=  M_PI - t3;`, `  if (y < 0.0) t3= -t3;`, `  return t3;`, '}'][`join`]('\x0a');
...
class FlameTransform extends Variation {
    ...
    [`getAffineArea`]() {
        return Math[`abs`](this[`_wvar`] * this[`_wvar`] * (this['_x'][0] * this['_y'][1] - this['_x'][1] * this['_y'][0]));
    }
    ...
    [`getCode`]() {
        var p = [`vec2 applyMap%TAG%(vec2 t) {`, `	t=xf%TAG%[0]*t.x+xf%TAG%[1]*t.y+xf%TAG%[2];`, ` 	vec2 p;`, `{	%CODE%
}`, `	return xf%TAG%[6].x*p;`, '}', `float jacobian%TAG%(vec2 t) {`, ` %AREA_CODE%`, '}', `float getDensity(vec2 t) {`, `	t=xf%TAG%[0]*t.x+xf%TAG%[1]*t.y+xf%TAG%[2];`, `	return 1.0/(1.0e-3+abs(xf%TAG%[7].x*jacobian%TAG%(t)));`, '}'][`join`]('\x0a');
        var q = {};
        q[`%TAG%`] = this[`_tag`];
    ...
    [`getInverseCode`]() {
        var p = [`float jacobian%TAG%(vec2 t) {`, ` %AREA_CODE%`, '}', `vec4 f%TAG%(vec2 inv) {`, `	float areaScale=1.0/(1.0e-2+abs(xf%TAG%[7].x*jacobian%TAG%(inv)));`, `	vec2 p=xf%TAG%[3]*inv.x+xf%TAG%[4]*inv.y+xf%TAG%[5];`, `	return areaScale*g%TAG%(p);`, '}', `vec4 nonlinear_inverse%TAG%(vec2 p) {`, `	p=p*xf%TAG%[6].y;`, `	%INV_CODE%`, '}'][`join`]('\x0a');
        var q = {};
        q[`%TAG%`] = this[`_tag`];
        q[`%INV_CODE%`] = variation_list[this[`_var`]][`getInverseCode`]()[`replace`](/\bf\x28/g, 'f' + this[`_tag`] + '(');
        q[`%AREA_CODE%`] = variation_list[this[`_var`]][`getAreaCode`]();
        var r = q;
        var t = this[`getUniformDecl`]() + expandString(p, r);
        return t;
...
function createFlameConfigX1() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.14, `linear`, 1, [-0.4999998, -0.8660256], [0.8660256, -0.4999998], [0, 0]], [0.22, `linear`, 1, [0.5, -0.8660254], [0.8660254, 0.5], [0, 0]], [0.5, `linear`, 1.22, [-1, 0], [10, -1], [-1.732051, -0.2]], [0.4, `spherical`, 0.4, [0.8689958, 0.101100525], [-0.01100525, 0.8689958], [0.02201051, -1.737992]]]);
        }
        [`getMapExposure`]() {
            return 0.66;
        }
...
function createFlameConfigX2() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.119449, `linear`, 0.9, [0.31, -3.71], [0.1, 0.5], [0.35, 0.8]], [0.2015748, `linear`, 0.7, [0.5, 0], [0, 0.5], [-0.5, 0]], [0.8976378, `spherical`, 0.1, [0.8, -0.4], [0.4, 0.8], [0.2, 0.4]], [0.6929134, `spherical`, 0.2, [-0.8, 0.4], [-0.4, -10.8], [0.02, -0.04]]]);
        }
        [`getMapExposure`]() {
            return 0.63749;
        }
...
function createFlameConfigX3() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.1, `spherical`, 0.66, [10.5, 10], [10, 0.5], [-1.35, 0]], [0.6, `fisheye`, 0.22, [10.8, -0.4], [0.14, 0.8], [-0.2, 0.2]], [0.5, `swirl`, 0.5, [-0.1, 0.4], [-0.1, -0.2], [10.2, 0.1]], [0.2, `spiral`, 0.3, [0.4, 0], [-0.1, 0.1], [-0.2, 0]]]);
        }
        [`getMapExposure`]() {
            return 7.4;
        }
...
function createFlameConfigX4() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.2, `linear`, 1, [0.5, 0], [0, 0.5], [0.5, 0]], [0.55, `linear`, 1, [0.5, 0], [0, 0.5], [-0.5, 0]], [0.8, `spherical`, 1.8, [0.8, -0.4], [0.4, 0.8], [0.2, 0.4]], [0.8, `spherical`, 0.4, [-0.8, 0.4], [-0.4, -0.8], [0.2, 0.4]]]);
        }
        [`getMapExposure`]() {
            return 0.6;
        }
...
function createFlameConfigX5() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.33, `linear`, 1.3, [0.5, 0], [0, 0.5], [0.5, 0]], [0.33, `spherical`, 0.3, [1, 0.5], [-0.5, 1], [0, -0.5]], [0.43, `spherical`, 0.4, [-1, -0.5], [0.5, -1], [1, 1]]]);
        }
        [`getMapExposure`]() {
            return 2.1;
        }
...
function createFlameConfigX6() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.35, `linear`, 0.7, [0.361507, 0.1303464], [-0.1303464, 0.361507], [0.625, 0]], [0.85, `linear`, 0.9, [0.08563109, 0.7551379], [-0.7551379, 0.08563109], [0, 0]], [0.35, `linear`, 1, [0.5003027, 0.8662202], [-0.8662202, 0.5003027], [0, 0]]]);
        }
        [`getMapExposure`]() {
            return 2.4;
        }
...
function createFlameConfigX() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.3333, `swirl`, 0.4, [6.5, 10], [0.44, 0.5], [0.33, 0.4]], [0.1333, `spherical`, 0.4, [0.7888, 0.9], [0.3, 0.8], [0.566, 0.5]], [0.63333, `diamond`, 0.6, [0.5, 0], [0, 0.5], [0, 10.551]]]);
        }
        [`getMapExposure`]() {
            return 30.4;
        }
...
function createFlameConfig0() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.3333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.2333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0.566, 0.4]], [0.3333, `hyperbolic`, 0.4, [0.5, 0], [0, 0.5], [0, -0.551]]]);
...
function createFlameConfig1() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.3333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.3333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0.566, 0.4]], [0.3333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0, -0.551]]]);
        }
        [`getMapExposure`]() {
            return 1.7;
        }
...
function createFlameConfig2() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.3333, `horseshoe`, 1.2, [-0.9970145, -0.984873], [0.16221, 0.946498], [-0.606021, 0.7473919]], [0.6333, `spherical`, 0.7, [0.235448, -0.599886], [0.571187, 0.322248], [-0.871327, 0.469188]]]);
            this[`animRate`] = [3, 5];
        }
        [`getMapExposure`]() {
            return 1.9096749;
        ...
        [`getColorful`]() {
            var p = smooth(Math[`min`](1, 8 * getHiHat(analyzers[`getBandAnalyzer`]())), hihat, 6);
            return 0.4 - p;
        }
        [`getTexScale`]() {
            return -0.8790305;
...
function createFlameConfig4() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.533, `sinusoidal`, 0.9, [4.172915, 9.464352], [-9.464352, 4.172915], [4.741241, -2.293564]], [0.333, `spherical`, 1, [0.4997272, 0.2070764], [-0.2070764, 0.4997272], [0, 0]], [0.333, `julia`, 1, [4.001953, 1.7e-7], [-1.7e-7, 4.001953], [0, 0]]]);
        }
        [`getMapExposure`]() {
            return 0.9096749;
        }
        ...
        [`getTexScale`]() {
            var p = smooth(Math[`min`](1, getHiHat(analyzers[`getHiHatAnalyzer`]()) * 2), hihat, 6);
            return 1 - 0.2 * p;
        }
        [`getFirstLevel`]() {
            return 6;
...
function createFlameConfig5() {
    let o = class extends FlameConfig {
        constructor() {
            super([[1.233, `julia`, -3.53, [4.001953, 1.7e-7], [-1.7e-7, 4.001953], [0, 0]], [0.13, `sinusoidal`, 1.532, [4.172915, 9.464352], [-9.464352, 4.172915], [4.741241, -2.293564]], [0.333, `spherical`, 0.4, [0.7997272, 0.2070764], [-0.2070764, 0.7997272], [0, 0]]]);
            this['sc'] = 0.1;
            this[`animRate`] = [3, 5, 5];
        }
        [`getMapExposure`]() {
...
function createFlameConfig6() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.333, `hyperbolic`, 0.45, [-5e-8, 1.25], [-1.25, -5e-8], [0.2, -0.4]], [1.233, `julia`, 4, [0.7457995, -0.06098665], [0.06098665, 0.7457995], [0.06173, -0.24791667]]]);
            this[`animRate`] = [3, 7];
        }
        [`getMapExposure`]() {
            return 2.4096749;
        ...
        [`getColorful`]() {
            var p = smooth(Math[`min`](1, getHiHat(analyzers[`getHiHatAnalyzer`]()) * 6), hihat, 6);
            return 7.13 + p * 3;
        }
        [`getTexScale`]() {
            return 0.55;
...
function createFlameConfig7() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.533, `hyperbolic`, 1.5, [-5e-8, 1.25], [-1.25, -5e-8], [0, 0]], [0.533, `spherical`, 1, [0.7457995, -0.06098665], [0.06098665, 0.7457995], [0.06173, -0.4791667]]]);
            this[`animRate`] = [1, 2];
        }
        [`getMapExposure`]() {
            return 0.813749;
...
function createFlameConfig8() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.4409449, `linear`, 1, [0.5, 0], [0, 0.5], [0.5, 0]], [0.4015748, `linear`, 1, [0.5, 0.55], [0.4, 0.5], [-0.5, 0]], [0.8976378, `spherical`, 0.5, [0.8, -0.4], [0.4, 0.8], [0.2, 0.4]], [0.6929134, `spherical`, 0.2, [-0.8, 0.4], [-0.4, -0.8], [0.2, 0.4]]]);
...
function createFlameConfig9() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.2, `linear`, 1.4, [10.5, 0], [0, 0.5], [0.5, 0]], [0.2, `linear`, 1, [0.5, 0], [10, 0.5], [-0.5, 0]], [0.8, `spherical`, 0.8, [0.1, -0.4], [0.4, 0.41], [0.333, 0.4]], [0.8, `spherical`, 0.4, [-10.8, 0.4], [-0.4, -110.8], [0.2, 0.4]]]);
...
function createFlameConfig10() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.33, `linear`, 1.3, [0.5, 0], [0, 0.5], [0.5, 0]], [0.43, `heart`, 1.1, [1, 0.5], [-0.5, 1], [0, -0.5]], [0.43, `spherical`, 0.4, [-1, -0.5], [0.5, -1], [1, 1]]]);
...
function createFlameConfig11() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.3333, `swirl`, 1, [-0.484358, 0.88212], [0.124088, 0.484358], [0, 0]], [0.3333, `linear`, 1, [0.0438976, -0.498069], [0.498069, 0.0438976], [1.3, 0]], [0.333, `linear`, 1, [0.5, 0], [0, 0.5], [0.3 * s, -s]]]);
...
function createFlameConfig12() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.33, `hyperbolic`, 0.4, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.33, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0.566, 0.4]], [0.33, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0, -0.551]]]);
            this[`animRate`] = [1, 1, 1, 1];
        }
        [`getMapExposure`]() {
            return 2.46727;
...
function createFlameConfig13() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.28393, `spherical`, 0.5, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.21053, `spherical`, 0.5, [0.5, 0], [0, 0.5], [0.566, 0.4]], [0.143482, `horseshoe`, 0.9, [0.5, 0], [0, 0.5], [0, -0.551]]]);
            this[`animRate`] = [1, 1, 1];
        }
        [`getMapExposure`]() {
            return 5.16944;
...
function skipAnimate(o, p, q) {
    ...
    for (t = 0; t < r[`length`]; t++) {
        ...
        var D = vec2[`subtract`](vec2[`create`](), vec2[`scale`](B, B, z), vec2[`scale`](C, C, A));
        var E = vec2[`fromValues`](o[`origX`][t][0], o[`origX`][t][1]);
        var F = vec2[`fromValues`](o[`origY`][t][0], o[`origY`][t][1]);
        var G = vec2[`add`](vec2[`create`](), vec2[`scale`](E, E, A), vec2[`scale`](F, F, z));
        r[t][`setX`](D);
        r[t][`setY`](G);
    }
}
...
function createFlameConfig14() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0.566, 0.4]], [-0.00382, `horseshoe`, 0.4, [0.5, 0], [0, 0.5], [0, -0.551]]]);
...
function createFlameConfig15() {
    let o = class extends FlameConfig {
        constructor() {
            super([[0.333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [-0.566, 0.4]], [0.333, `spherical`, 0.4, [0.5, 0], [0, 0.5], [0.566, 0.4]], [0.333, `swirl`, 0.4, [0.5, 0], [0, 0.5], [0, -0.551]]]);
            this[`animRate`] = [-1, 1, 4];
            initAbsRotation(this);
        }
        [`getMapExposure`]() {
...
class FlameConfig {
    ...
    [`defaultAnimate`](o) {
        ...
        for (var q = 0; q < p[`length`]; q++) {
            ...
            var B = p[q][`getX`]();
            var C = p[q][`getY`]();
            var D = vec2[`add`](vec2[`create`](), vec2[`scale`](B, B, v), vec2[`scale`](C, C, u));
            p[q][`setX`](A);
            p[q][`setY`](D);
        }
    }
...
;class Furnance {
    constructor(o) {
        gl = o;
        var p = gl[`getExtension`](`OES_float_linear`) || gl[`getExtension`](`OES_half_float_linear`);
        if (p) {
    ...
    [`bad_framebuffer`](o) {
        ...
        case gl[`FRAMEBUFFER_COMPLETE`]:
            this[`errorExit`](`gl.framebufferTexture2D`, `framebuffer is actually OK (?!)`);
            break;
        case gl[`FRAMEBUFFER_UNSUPPORTED`]:
            this[`errorExit`](`gl.framebufferTexture2D`, `combination of formats is UNSUPPORTED by your card`);
            break;
        case gl[`FRAMEBUFFER_INCOMPLETE_ATTACHMENT`]:
            this[`errorExit`](`gl.framebufferTexture2D`, `FRAMEBUFFER_INCOMPLETE_ATTACHMENT`);
            break;
        case gl[`FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT`]:
            this[`errorExit`](`gl.framebufferTexture2D`, `FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT`);
            break;
        case gl[`FRAMEBUFFER_INCOMPLETE_DIMENSIONS`]:
            this[`errorExit`](`gl.framebufferTexture2D`, `FRAMEBUFFER_INCOMPLETE_DIMENSIONS`);
            break;
        default:
    ...
    [`getInversFnsSnippet`](p) {
        var q = [`/*------------------- w%TAG% -----------------*/`, `uniform vec4 color%TAG%;`, `vec4 g%TAG%(vec2 p) {`, `	return exp2(texture(tex,TXfmPL(p))*20.0)-1.0;`, '}', `%INV_CODE%`][`join`]('\x0a');
        var r = '';
        var t;
...
`, `precision highp  float;`, `out vec2 destcoords;`, `in vec4 leg_gl_Vertex;`, `uniform mat4 leg_gl_ProjectionMatrix;`, `uniform mat4 leg_gl_ModelViewMatrix;`, `void main(void) {`, `	destcoords = vec2(leg_gl_Vertex);`, `	gl_Position = leg_gl_ProjectionMatrix * leg_gl_ModelViewMatrix * leg_gl_Vertex;`, '}'][`join`]('\x0a');
            var t = [`#version 300 es
`, `precision highp  float;`, `in vec2 destcoords;`, `uniform sampler2D tex;`, `out vec4 glColor;`, GLSL_PLutil, PLANE_TEX_FUNCs, `%INV_FUNCS%`, `vec4 sum_inverses(vec2 p) {`, `	vec4 sum=vec4(0.0);`, `%SUM_FUNCS%`, `	return log2(sum+1.0)*(1.0/20.0);`, '}', `void main(void) {`, `	glColor = sum_inverses(PLfmTX(destcoords));`, '}'][`join`]('\x0a');
            ...
            for (A = 0; A < p[`length`]; A++) {
                if (p[A][`hasInverse`](this[`config`][`getForceVertexOnly`]())) {
                    ...
                    this[`progPerPixMap`][`uniformLocs`][A] = gl[`getUniformLocation`](this[`progPerPixMap`], `color` + p[A][`getTag`]());
                }
            }
        ...
        for (A = 0; A < p[`length`]; A++) {
            if (p[A][`hasInverse`](this[`config`][`getForceVertexOnly`]())) {
                ...
                gl[`uniform4fv`](this[`progPerPixMap`][`uniformLocs`][A], this[`mapColor`](p, A));
            }
        }
        opengl[`draw_texture`](this[`progPerPixMap`], mat4[`create`](), [-1, -1, 0.5], [1, 1, 0.5]);
        gl[`useProgram`](null);
    }
    [`TXfmPL`](o, p) {
        o *= p;
    ...
    [`useSeedShader`]() {
        if (!this[`seedShader`]) {
            var o = opengl[`loadShader`](gl[`VERTEX_SHADER`], `#version 300 es
            ...
            var p = opengl[`loadShader`](gl[`FRAGMENT_SHADER`], `#version 300 es
    ...
    [`draw_pervertex_map`](o, p) {
        ...
        var z = gl[`createBuffer`]();
        gl[`bindBuffer`](gl[`ARRAY_BUFFER`], z);
        gl[`bufferData`](gl[`ARRAY_BUFFER`], new Float32Array(this[`cachedVertices`]), gl[`STATIC_DRAW`]);
        z[`itemSize`] = 3;
    ...
    [`simulate_pervertex_map`](p, q, r) {
        if (this[`xfm_prog`][r] == 0 || !p[r][`equals`](this[`xfm_cached_vx`][r])) {
            var t = [`#version 300 es
`, `precision highp float;`, GLSL_PLutil, PLANE_TEX_FUNCs, ` %VAR_CODE%`, `vec2 applyMap(vec2 t) {`, `	return TXfmPL(applyMap%ID%(PLfmTX(t)));`, '}', `out vec4 color;`, `out vec2 texcoords;`, `in vec4 leg_gl_Color;`, `in vec4 leg_gl_Vertex;`, `uniform mat4 leg_gl_ProjectionMatrix;`, `uniform mat4 leg_gl_ModelViewMatrix;`, `void main(void) {`, `	texcoords=vec2(leg_gl_Vertex);`, `	vec2 onscreen=applyMap(texcoords);`, `	color=getDensity(texcoords)*leg_gl_Color;`, `	gl_Position = leg_gl_ProjectionMatrix * leg_gl_ModelViewMatrix * vec4(onscreen,0,1);`, '}'][`join`]('\x0a');
            var u = [`#version 300 es
`, `precision highp float;`, `in vec4 color;`, `in vec2 texcoords;`, `uniform sampler2D tex;`, `out vec4 glColor;`, `void main(void) {`, `	glColor = color*texture(tex,texcoords);`, '}'][`join`]('\x0a');
        ...
        if (this[`texLevels`] == 0) {
            ...
            for (p = 0; p <= o; p++) {
                ...
                for (q = 0; q < 2; q++) {
                    ...
                    gl[`texImage2D`](gl[`TEXTURE_2D`], 0, gl[`RGBA`], r, r, 0, gl[`RGBA`], u, null);
                    var v = gl[`getExtension`](`EXT_texture_filter_anisotropic`) || gl[`getExtension`](`MOZ_EXT_texture_filter_anisotropic`) || gl[`getExtension`](`WEBKIT_EXT_texture_filter_anisotropic`);
                    if (v) {
                        gl[`texParameterf`](gl[`TEXTURE_2D`], v[`TEXTURE_MAX_ANISOTROPY_EXT`], 16);
                    }
...
class DemoMain {
    constructor() {
        this[`sizeX`] = 800;
        this[`sizeY`] = 600;
        this[`flameConfigs`] = [[1000, 15, 1000, createFlameConfig11()], [1000, 15, 1000, createFlameConfigX5()], [1000, 15, 1000, createFlameConfigX6()], [1000, 15, 1000, createFlameConfigX4()], [1000, 15, 1000, createFlameConfig14()], [1000, 15, 1000, createFlameConfigX3()], [1000, 15, 1000, createFlameConfigX2()], [1000, 15, 1000, createFlameConfig12()], [1000, 15, 1000, createFlameConfig10()], [1000, 15, 1000, createFlameConfigX()], [1000, 15, 1000, createFlameConfig6()], [1000, 15, 1000, createFlameConfig2()], [1000, 15, 1000, createFlameConfig1()], [1000, 15, 1000, createFlameConfig7()], [1000, 15, 1000, createFlameConfig9()], [1000, 15, 1000, createFlameConfig4()], [1000, 15, 1000, createFlameConfig5()], [1000, 15, 1000, createFlameConfigX1()], [1000, 15, 1000, createFlameConfig0()], [1000, 15, 1000, createFlameConfig8()]];
        this[`furnance`];
    ...
    [`drawSpectrum`](o) {
        if (this[`ctxSpectrum`]) {
            if (o) {
                ...
                this[`ctxSpectrum`][`clearRect`](0, 0, this[`spectrumWidth`], this[`spectrumHeight`]);
                this[`ctxSpectrum`][`fillStyle`] = `#A0A0A0`;
                for (var u = 0; u < t; ++u) {
                    var v = p[Math[`floor`](u / t * p[`length`])];
                    this[`ctxSpectrum`][`fillRect`](u * (q + r), this[`spectrumHeight`], r, -this[`spectrumHeight`] * v / 255);
                }
            }
        } else {
    ...
    [`init`]() {
        ...
        cloudPlayer[`initMusic`](function() {
            this[`isMusicReady`] = !false;
        }
        [`bind`](this));
    ...
    [`getPostprocessShader`]() {
        if (typeof this[`postprocessProg`] == `undefined`) {
            this[`postprocessProg`] = opengl[`makeProgramObject`]([`#version 300 es
`, `precision highp float;`, `out vec3 worldCoords;`, `in vec4 leg_gl_Vertex;`, `void main(void) {`, `	worldCoords = vec3(leg_gl_Vertex );`, `	gl_Position = leg_gl_Vertex;`, '}'][`join`]('\x0a'), [`#version 300 es
`, `precision highp float;`, `float ab(float x) { return x/sqrt(1.0+x*x)*0.5+0.5; }`, `vec2 ab(vec2 p) { return vec2(ab(p.x),ab(p.y)); }`, `in vec3 worldCoords;`, `out vec4 fragColor;`, `uniform sampler2D uTexture;`, `uniform float uColormode;`, `uniform vec2 uScale;`, `uniform vec2 uMove;`, `uniform float uFade;`, `uniform float uDither[64];`, `uniform float uMix;`, `float Scale = 1.0;`, `float find_closest(int x, int y, float c0) {`, `float limit = 0.0;`, `if(x < 8) {`, `int index = x + y*8;`, `limit = (uDither[index]+1.0)/64.0;`, '}', `if(c0 < limit)`, `	return 0.0;`, `return 1.0;`, '}', `void main(void) {`, `vec2 uv=ab(vec2(uScale.x*(worldCoords.x+uMove.x) ,uScale.y*((worldCoords.y+uMove.y))));`, `vec3 rgb = texture(uTexture, uv).rgb;`, `rgb= (rgb*uColormode + (1.0-rgb)*(1.0-uColormode))*uFade;`, `vec3 c;`, `if (uMix > 0.0) {`, `vec2 xy = gl_FragCoord.xy * Scale;`, `int x = int(mod(xy.x, 8.0));`, `int y = int(mod(xy.y, 8.0));`, `c.r = find_closest(x, y, rgb.r);`, `c.g = find_closest(x, y, rgb.g);`, `c.b = find_closest(x, y, rgb.b);`, `c= mix(c, rgb, uMix);`, `} else {`, `c= rgb;`, '}', `fragColor = vec4(c, 1.0);`, '}'][`join`]('\x0a'));
            this[`postprocessProg`][`uScale`] = gl[`getUniformLocation`](this[`postprocessProg`], `uScale`);
            this[`postprocessProg`][`uMove`] = gl[`getUniformLocation`](this[`postprocessProg`], `uMove`);
            this[`postprocessProg`][`uColormode`] = gl[`getUniformLocation`](this[`postprocessProg`], `uColormode`);
            this[`postprocessProg`][`uFade`] = gl[`getUniformLocation`](this[`postprocessProg`], `uFade`);
            this[`postprocessProg`][`uTexture`] = gl[`getUniformLocation`](this[`postprocessProg`], `uTexture`);
            this[`postprocessProg`][`uDither`] = gl[`getUniformLocation`](this[`postprocessProg`], `uDither`);
            this[`postprocessProg`][`uMix`] = gl[`getUniformLocation`](this[`postprocessProg`], `uMix`);
        }
    ...
    [`drawScene`](o, p, q) {
        ...
        gl[`uniform1f`](t[`uColormode`], this[`furnance`][`getConfig`]()[`getMapExposure`]() < 0 ? 0 : 1);
        gl[`uniform1f`](t[`uFade`], q);
        var w = this[`decay`](getBassX());
        gl[`uniform1f`](t[`uMix`], 1 - w);
        gl[`uniform1fv`](t[`uDither`], [0, 32, 8, 40, 2, 34, 10, 42, 48, 16, 56, 24, 50, 18, 58, 26, 12, 44, 4, 36, 14, 46, 6, 38, 60, 28, 52, 20, 62, 30, 54, 22, 3, 35, 11, 43, 1, 33, 9, 41, 51, 19, 59, 27, 49, 17, 57, 25, 15, 47, 7, 39, 13, 45, 5, 37, 63, 31, 55, 23, 61, 29, 53, 21]);
        var y = 1;
...
function startDemo() {
    ...
    window[`requestAnimFrame`] = function() {
        return window[`requestAnimationFrame`] || window[`webkitRequestAnimationFrame`] || window[`mozRequestAnimationFrame`] || window[`oRequestAnimationFrame`] || window[`msRequestAnimationFrame`] || function(o, p) {
